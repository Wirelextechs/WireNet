      ...
      <header className="sticky top-0 z-40 border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="mx-auto flex max-w-6xl items-start justify-between gap-4 px-4 py-4">
          <div className="space-y-1">
            ...
            <h1 className="text-xl font-semibold tracking-tight">AT ISHARE - HIGH-SPEED DATA</h1>
            <p className="text-sm text-muted-foreground">Instant Delivery - Fast and Reliable</p>
          </div>
      ...
      <main className="mx-auto max-w-6xl px-4 py-6">
        ...
        {loading ? (
          ...
          <div style={styles.packagesGrid}>
            {packages.map((pkg) => (
              ...
              >
                <p style={{...styles.packageCardName, color: "#dc2626"}}>{pkg.dataAmount}</p>
        ...
        <div style={styles.purchaseSection} ref={purchaseSectionRef}>
          <div style={styles.purchaseCard}>
            ...
            <Input
              type="tel"
              placeholder="Enter AT number (e.g. 050...)"
              value={phoneNumber}
          ...
          <div style={styles.purchaseCard}>
            ...
            {selectedPackage ? (
              <div style={styles.selectedPackageInfo}>
                <p style={{...styles.packageName, color: "#dc2626"}}>{selectedPackage.dataAmount}</p>
          ...
          <div style={styles.cartSection}>
            ...
            <div style={styles.cartSummary}>
              ...
              <Button
                ...
                disabled={purchasing}
                style={{...styles.checkoutButton, backgroundColor: "#dc2626"}}
              >
